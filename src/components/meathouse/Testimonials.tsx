...
const testimonials = [
  {
    ...
    location: "الفيوم",
    rating: 5,
    text: "أفضل معرض لحوم في الفيوم! اللحوم دائماً طازجة وجودة ممتازة. خدمة التوصيل سريعة ومحترفة.",
    avatar: "أ",
  },
  {
    name: "منال عبد الله",
  ...
  },
  {
    ...
    location: "الفيوم",
    rating: 5,
    text: "من أفضل التجارب! اللحوم طازجة . التوصيل في الوقت المحدد بدقة.",
    avatar: "أ",
  },
];
