...
const values = [
  ...
  },
  {
    icon: Star,
    title: "ثقة العملاء",
    description: "بنينا علاقة قوية مع عملائنا على مدار سنوات من الخدمة المتميزة",
  },
  {
    icon: Users,
    title: "فريق محترف",
          ...
          >
            ...
            <div className="space-y-4 mb-10">
              {milestones.map((milestone, index) => (
                ...
                >
                  <CheckCircle className="w-5 h-5 text-crimson-light flex-shrink-0" />
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-l from-crimson to-crimson-dark text-white font-bold rounded-full hover:shadow-2xl hover:shadow-crimson/30 transition-all duration-300"
            >
              تواصل معنا
            </motion.a>
          </motion.div>
          ...
          <div className="space-y-6">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-crimson/20 to-gold/20 flex items-center justify-center flex-shrink-0 group-hover:from-crimson/30 group-hover:to-gold/30 transition-all duration-300">
            ...
            <motion.div
              ...
              className="relative p-6 rounded-2xl bg-gradient-to-l from-crimson/10 to-gold/5 border border-crimson/10"
            >
              ...
              <p className="text-gray-300 italic leading-relaxed text-sm">
                &ldquo;الجودة ليست ما تفعله أحياناً، إنها ما تفعله دائماً.
                نحن في بيت اللحوم نعيش هذا المبدأ في كل قطعة لحوم
                نقدمها.&rdquo;
              </p>
